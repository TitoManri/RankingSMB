...
<body>
  ...
  <div class="container container-fluid contenedor">
      <div class="row gx-3">
        <div class="col-2">
          <a href="./listaFavoritosMyS.php" class="hvr-radial-in-L-Favorito hvr-round-corners">
            <img src="../assets/img/heart.png" class="rounded  cuadrado-L" alt="">
          </a>
        </div>
        <div class="col-2">
          <a href="./listaPorVerMyS.php" class="hvr-radial-in-L-PorVer hvr-round-corners">
            <img src="../assets/img/vision (1).png" class="rounded  cuadrado-L" alt="">
          </a>        
        </div>
        <div class="col-2">
          <a href="./listaVistoMyS.php" class="hvr-radial-in-L-Visto hvr-round-corners">
