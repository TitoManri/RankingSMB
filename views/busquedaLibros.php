...
<body>
        ...
        <div class="columns">
            <div class="column is-full featured_wrapper p-0">
                ...
                <div class="title_wrapper">
                    ...
                    <button id="boton-contenido" class="button is-medium">Busqueda de libros</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- búsqueda-->
    <?php
    if (isset($_POST['busquedaLibroText'])) {
        $busqueda = htmlspecialchars($_POST['busquedaLibroText']);  
    ...
    <div class="container p-0 pt-6 last">
        ...
        <div id="libros2" class="columns is-multiline">
            <!-- se insertan los libros por medio de js -->
        </div>

        <div id="libros3" class="columns last">
            <!-- se insertan los libros por medio de js -->
        </div>
    </div>
...
<script src="./assets/js/busquedaLibrosP.js"></script>
