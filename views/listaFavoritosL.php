...
<body>
  ...
  <article class="container">
    <div class="row">
      <div class="col-6">
        <h1 class="text-center Nombre_Grande">Libros Favoritos</h1>
      </div>
  ...
  <ul id="favoritos">
    <!-- Aquí se listan los libros favoritos -->
...
<script src="./assets/js/Listas/Libros/Favoritos/ListarLista.js"></script>
