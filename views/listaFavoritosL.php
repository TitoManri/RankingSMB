...
<body>
  ...
  <h1 class="text-center Nombre_Grande">Libros Favoritas</h1>
    ...
    <div class="row">
      ...
      <div class="col-3">
        <label for="id_label_multiple">
          <select class="js-example-basic-multiple js-states form-control filtro" id="id_label_multiple" multiple="multiple">
  ...
  <article class="container contenedor container-Fav">
    <div class="row">
      <div class="col-12 ">
        <div class="UnaLinea">
