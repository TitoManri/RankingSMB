...
<head>
  ...
  <title>Lista de libros Por Leer</title>
...
<body>
  ...
  <article class="container">
    <div class="row">
      <div class="col-6">
        <h1 class="text-center Nombre_Grande">Libros Por Leer</h1>
      </div>
  ...
  <ul id="favoritos">
    <div class="container contenedor container-Fav"></div>
  </ul>
</body>
...
<script src="./assets/js/Listas/Libros/PorVer/ListarListaPorVer.js"></script>
